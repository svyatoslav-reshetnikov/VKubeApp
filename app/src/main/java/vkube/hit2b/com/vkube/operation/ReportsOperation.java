...
import vkube.hit2b.com.vkube.data.factory.ReportsJsonFactory;
import vkube.hit2b.com.vkube.network.URLs;

/**
 * Created by svyat on 07.02.15.
 */
public class ReportsOperation implements RequestService.Operation {

    public static String PARAM_AMOUNT = "";
    public static String PARAM_REPORTS_URL = "";
    ...
    public Bundle execute(Context context, Request request) throws ConnectionException,
        ...
        return ReportsJsonFactory.parseResult(result.body);
    }
}